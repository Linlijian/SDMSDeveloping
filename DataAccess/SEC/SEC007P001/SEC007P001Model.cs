...
{
    [Validator(typeof(SEC007P001Validator))]
    [Serializable]
    public class SEC007P001Model : StandardModel
    {
        public decimal? USG_ID { get; set; }
        [Display(Name = "USG_CODE", ResourceType = typeof(Translation.SEC.SEC007P001))]
        public string USG_CODE { get; set; }
        [Display(Name = "USG_NAME_TH", ResourceType = typeof(Translation.SEC.SEC007P001))]
        public string USG_NAME_TH { get; set; }
        [Display(Name = "USG_NAME_EN", ResourceType = typeof(Translation.SEC.SEC007P001))]
        public string USG_NAME_EN { get; set; }
        [Display(Name = "USG_STATUS", ResourceType = typeof(Translation.SEC.SEC007P001))]
        public string USG_STATUS { get; set; }
        public List<DDLCenterModel> USG_STATUS_MODEL { get; set; }
        [Display(Name = "USG_LEVEL", ResourceType = typeof(Translation.SEC.SEC007P001))]
        public string USG_LEVEL { get; set; }
        public List<DDLCenterModel> USG_LEVEL_MODEL { get; set; }

        [Display(Name = "SYS_NAME", ResourceType = typeof(Translation.SEC.SEC007P001))]
        public string SYS_CODE { get; set; }

        [Display(Name = "SYS_GROUP_NAME", ResourceType = typeof(Translation.SEC.SEC007P001))]
        ...
        public List<SEC007P00101Model> PRIV_MODEL { get; set; }
    }

    public class SEC007P00101Model : StandardModel
    {
    ...
    public class SEC007P001Validator : AbstractValidator<SEC007P001Model>
    {

        public SEC007P001Validator()
        {
            RuleSet("Add", () =>
            {
